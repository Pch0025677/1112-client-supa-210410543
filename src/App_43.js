...
import MenuLocalJsonPage_43 from "./pages/local/MenuLocalJsonPage_43";
import CrownStaticPage_43 from "./pages/local/CrownStaticPage_43";
...
const App_43 = () => {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path='/local_menu_43' element={<MenuLocalJsonPage_43 />} />
      ...
      <Route path='/CrownStaticPage_43' element={<CrownStaticPage_43 />} />
    </Routes>
  </BrowserRouter>
  );
}
